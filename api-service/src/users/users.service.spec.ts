...
describe('UsersService', () => {
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        { provide: MailService, useValue: { sendEmailWithNewPassword: jest.fn() } },
  ...
  describe('findByEmail', () => {
    it('should be throw if repository throw', async () => {
      ...
      await expect(service.findByEmail('INVALID')).rejects.toThrow(new Error());
    });
  ...
  describe('findById', () => {
    it('should be throw if repository throw', async () => {
      ...
      await expect(service.findById('INVALID')).rejects.toThrow(new Error());
    });
  ...
  describe('createUser', () => {
    it('should be throw if repository throw', async () => {
      ...
      await expect(service.createUser(dto)).rejects.toThrow(new Error());
    });
